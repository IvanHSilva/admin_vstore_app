import 'package:admin_vstore/blocs/orders_block.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _buildFloanting(),
    );
  }

  Widget _buildFloanting(){
    switch(_page){
      case 0: 
        return null;
      case 1:
        return SpeedDial(
          ...
          children: [
            SpeedDialChild(
              ...
              onTap: (){
                _ordersBloc.sortOrderCriteria(SortCriteria.READY_LAST);
              }
            ),
            SpeedDialChild(
              child: Icon(
              ...
              labelStyle: TextStyle(fontSize: 14),
              onTap: (){
                _ordersBloc.sortOrderCriteria(SortCriteria.READY_FIRST);
              }
            ),
          ],
        );
