...
class UserBloc extends BlocBase {
  ...
  void _subsribeToOrders(String uid) {
    _users[uid]['subsciption']= _firestore.collection('users').document(uid).collection('orders')
  ...
  void _uinsubscribeToOrders(String uid) {
